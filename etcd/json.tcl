...
namespace eval ::etcd::json {}

proc ::etcd::json::parse {str {numberDictArrays 0}} {
    set result [::etcd::json::decode-value $str $numberDictArrays]
...
# e.g., {0 a 1 b} to ["a", "b"].
proc ::etcd::json::stringify {dictionaryOrValue {numberDictArrays 1}} {
    set result {}
    if {[llength $dictionaryOrValue] <= 1} {
        ...
        if {$numberDictArrays && $allNumeric} {
            ...
            set arrayElements {}
            foreach x $values {
                lappend arrayElements [::etcd::json::stringify $x 1]
            }
            ...
            set objectDict {}
            foreach {key value} $dictionaryOrValue {
                lappend objectDict "\"$key\": [::etcd::json::stringify $value 0]"
            }
...
# parsed. E.g., ::etcd::json::decode-value {"string", 55} returns {{string} {, 55}}.
proc ::etcd::json::decode-value {str {numberDictArrays 0}} {
    set str [string trimleft $str]
    switch -regexp -- $str {
        {^\".*} {
            return [::etcd::json::decode-string $str]
        }
        {^[0-9-].*} {
            return [::etcd::json::decode-number $str]
        }
        {^\{.*} {
            return [::etcd::json::decode-object $str $numberDictArrays]
        }
        {^\[.*} {
            return [::etcd::json::decode-array $str $numberDictArrays]
        }
        {^(true|false|null)} {
	    return [::etcd::json::decode-boolean-or-null $str]
        }
        default {
...
proc ::etcd::json::decode-boolean-or-null {str} {
...
proc ::etcd::json::decode-string {str} {
...
proc ::etcd::json::decode-number {str} {
...
proc ::etcd::json::decode-array {str {numberDictArrays 0}} {
    set strInitial $str
    set result {}
    set value {}
    set i 0
    ...
    while 1 {
        # Value.
        lassign [::etcd::json::decode-value $str $numberDictArrays] value str
        set str [string trimleft $str]
        if {$numberDictArrays} {
            lappend result $i
        }
...
proc ::etcd::json::decode-object {str {numberDictArrays 0}} {
    set strInitial $str
    set result {}
    set value {}
    if {[string index $str 0] ne "\{"} {
    ...
    while 1 {
        # Key string.
        set str [string trimleft $str]
        lassign [::etcd::json::decode-string $str] value str
        set str [string trimleft $str]
        lappend result $value
